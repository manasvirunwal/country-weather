...
import {haze, sunny, snow, rainy } from '../assets/Backgroundimages/index';
...
export default function Weather({ weatherData, fetchWeatherData }){
    ...
    useEffect(() => {
        setBackgroundimages(getBackgroundImg(main));
    },[weatherData])
    ...
    let textColor = Backgroundimages !== sunny ? 'white':'black'
